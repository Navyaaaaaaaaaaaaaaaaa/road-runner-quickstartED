...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1852.3554538238202; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1606.111429612667; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -53.13113469181979; // x position of the perpendicular encoder (in tick units)
    }
